...
MODEL_DIRS = {
    ...
    "FitabR_No_Residual": "exp/fitabr_no_residual/pima/0-ensemble-5",
    "FitabR_No_Scale": "exp/fitabr_no_scale/pima/0-ensemble-5",
    "FitabR_Uniform": "exp/fitabr_uniform/pima/0-ensemble-5",
}
