...
MODEL_DIRS = {
    ...
    "FitabR_No_Residual": "exp/fitabr_no_residual/stroke/0-ensemble-5",
    "FitabR_No_Scale": "exp/fitabr_no_scale/stroke/0-ensemble-5",
    "FitabR_Uniform": "exp/fitabr_uniform/stroke/0-ensemble-5",
}
...
publication_df.to_csv(
    output_dir / "stroke_comparison_table.csv",
    index=False,
)

publication_df.to_latex(
    output_dir / "stroke_comparison_table.tex",
    index=False,
    escape=False,
)
