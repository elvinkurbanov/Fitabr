...
class Model(nn.Module):
    def __init__(
        ...
        *,
        ...
        # =========================
        # FiTabR: manual feature weights
        # =========================
        self.manual_weights = torch.tensor(
               [1.0, 1.8, 0.8, 0.7, 0.7, 1.5, 1.2, 1.1]  # Pima = 8 features
        )
        # >>> R
    ...
    # =========================
    # FiTabR: apply manual weights
    # =========================
              weights = self.manual_weights.to(x_num.device).type_as(x_num)

              x_num_weighted = x_num * weights
