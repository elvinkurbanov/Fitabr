...
MODEL_DIRS = {
    "CatBoost": "exp/catboost_/stroke/0-ensemble-5",
    "XGBoost": "exp/xgboost_/stroke/0-ensemble-5",
    "KNN": "exp/knn/stroke/0-ensemble-5",
    "LightGBM": "exp/lightgbm_/stroke/0-ensemble-5",
    "MLP": "exp/mlp/stroke/0-ensemble-5",
    "SAINT": "exp/saint/stroke/0-ensemble-5",
    "FT-Transformer": "exp/ft_transformer/stroke/0-ensemble-5",
    "TabR": "exp/tabr/stroke/0-ensemble-5",
    "FiTabR": "exp/fitabr/stroke/0-ensemble-5",
}
...
if results_df.empty:
    raise RuntimeError("No Stroke ensemble reports were found.")
...
publication_df.to_csv(
    output_dir / "stroke_ensemble_publication_table.csv",
    index=False,
)

publication_df.to_latex(
    output_dir / "stroke_ensemble_publication_table.tex",
    index=False,
    escape=False,
)
